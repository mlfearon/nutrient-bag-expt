## Code to produce the path models in the manuscript titled:
...
here::i_am("scripts/Penczykowski_et_al_PathModels_20230215.R")
...
##################################################################################################
# Test of + Spores path models without infection density (testing for model power)
##################################################################################################
...
####################################################
# Check of all component models and assumptions
####################################################
